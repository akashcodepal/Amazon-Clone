    ...
    return (
        <div className="login">
            ...
            <div className="login_form" >
                ...
                <p>By continuing, you agree to Amazon's <span className="login_form_pSpan">Conditions of Use</span> and <span className="login_form_pSpan">Privacy Notice.</span></p>
            </div>

            <span className="login_line"></span>
            <span className="login_linePara"> New to Amazon?</span>
